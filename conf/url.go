...
const (
	...
	API_FANS_DATA = "/api/douyin/v1/user/fans_data/" //"/fans/data/"
	...
	//获取主播历史开播的房间ID
	API_ROOM_DATA_ROOM_ID_GET = "/room/data/room_id/get/"

	//获取直播间基础数据
	API_ROOM_DATA_BASE_GET = "/room/data/base/get/"

	//获取直播间看播数据
	API_ROOM_DATA_AUDIENCE_GET = "/room/data/audience/get/"
)
